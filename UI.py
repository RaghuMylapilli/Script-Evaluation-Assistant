...
input_entry.place(x = 720, y = 150, height = 100, width = 500)

execute_button = Button(window, text = 'Execute', command = get_script_output)
execute_button.place(x = 720, y = 280, height = 30, width = 140)

grade_label = Label(window, text = 'Grade', relief = RAISED)
grade_label.place(x = 600, y = 350, height = 30, width = 100)

grade_entry = Entry(window)
grade_entry.place(x = 720, y = 350, height = 30, width = 120)

feedback_label = Label(window, text = 'Feedback', relief = RAISED)
feedback_label.place(x = 600, y = 400, height = 30, width = 100)
